...
if [ $c_value1 = "install" ]
then
	if [ -e /tmp/hdd/volumes/HDD1/scripts ]
	then
		storage=/tmp/hdd/volumes/HDD1
		loc="HDD"
	elif [ -e /tmp/usbmounts/sda1/scripts ]
	then
		storage=/tmp/usbmounts/sda1
		loc="USB1"
	elif [ -e /tmp/usbmounts/sdb1/scripts ]
	then
		storage=/tmp/usbmounts/sdb1
		loc="USB1"
	elif [ -e /tmp/usbmounts/sdc1/scripts ]
	then
		storage=/tmp/usbmounts/sdc1
		loc="USB1"
	elif [ -e /tmp/usbmounts/sda2/scripts ]
	then
		storage=/tmp/usbmounts/sda2
		loc="USB2"
	elif [ -e /tmp/usbmounts/sdb2/scripts ]
	then
		storage=/tmp/usbmounts/sdb2
		loc="USB2"
	elif [ -e /tmp/usbmounts/sdc2/scripts ]
	then
		storage=/tmp/usbmounts/sdc2
		loc="USB2"
	elif [ -e /tmp/usbmounts/sda/scripts ]
	then
		storage=/tmp/usbmounts/sda
		loc="USB"
	elif [ -e /tmp/usbmounts/sdb/scripts ]
	then
