...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://xfilmeonline.ro/category/filme/page/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://xfilmeonline.ro/category/filme/");
    }
}
...
//$link = rawurlencode($link);   
    ...
    $link = 'http://127.0.0.1:82/scripts/php/xfilmeonline_link.php?file='.$link;
    echo '<item>';
