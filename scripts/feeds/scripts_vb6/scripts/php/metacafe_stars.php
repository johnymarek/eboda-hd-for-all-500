...
<channel>
	<title>Metacafe - Rising Stars</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.metacafe.com/rising_stars/page-".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.metacafe.com/rising_stars/page-1/");
    }
}
