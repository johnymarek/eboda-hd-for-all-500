...
if($page) {
  $html = file_get_contents("http://www.mediadirect.ro/cinemateca-pagina-".$page.".html");
} else {
  $page = 1;
	$html = file_get_contents("http://www.mediadirect.ro/cinemateca-pagina-1.html");
}
