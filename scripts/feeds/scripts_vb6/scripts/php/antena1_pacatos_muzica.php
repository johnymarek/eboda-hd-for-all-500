...
<channel>
	<title>Un show pacatos - Muzica</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://unshowpacatos.antena1.ro/ajax.php?action=showVideosArchive&section=muzica&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
