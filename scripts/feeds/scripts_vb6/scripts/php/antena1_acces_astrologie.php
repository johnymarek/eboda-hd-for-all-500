...
<channel>
	<title>Acces direct - Astrologie</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://accesdirect.antena1.ro/ajax.php?action=showVideosArchive&section=astrologie&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
