...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.filmeonlinesubtitrate.ro/page/".$page."");
    }
} else {
    $page = 1;
    if($search) {
...
$videos = explode('<div class="posthome">', $html);
...
foreach($videos as $video) {
    ...
    $t1 = explode('title="Vezi Filmul ', $video);
    $t2 = explode('online gratis cu subtitrare in limba romana', $t1[1]);
    $title = trim($t2[0]);
