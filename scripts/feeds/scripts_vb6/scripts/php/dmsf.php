...
<channel>
	<title>dailymotion - shortfilms</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/shortfilms/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/shortfilms/1");
    }
}
