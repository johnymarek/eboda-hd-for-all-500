...
<channel>
	<title>220.ro - Cele mai tari filme</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.220.ro/cele-mai-vazute/".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.220.ro/cele-mai-vazute/");
    }
}
