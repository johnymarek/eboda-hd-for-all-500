...
if($page) {
    $html = file_get_contents("http://www.uefa.com/uefachampionsleague/video/index,page=".$page.".htmx");
} else {
    $page = 1;
    $html = file_get_contents("http://www.uefa.com/uefachampionsleague/video/index.html");
}
