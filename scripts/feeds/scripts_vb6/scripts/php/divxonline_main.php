...
//	foreach($vids as $vid) {
    ...
    if (strpos($link,"?do=cat") !== false) {
    	...
    	$link1 ="http://ims.hdplayers.net/scripts/php/divxonline.php?query=,http://divxonline.biz/".$t3[1]."/";
    	...
    	print "\n";
  		...
  		$link1 = "http://ims.hdplayers.net/scripts/php/divxonline.php?query=,http://divxonline.biz".$link;
  		$t1 = explode('title="', $video);
    	$t2 = explode('"', $t1[1]);
    	$title = $t2[0];
