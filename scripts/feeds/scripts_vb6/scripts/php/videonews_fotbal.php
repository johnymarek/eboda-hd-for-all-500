...
<channel>
	<title>videonews.ro - fotbal</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://videonews.ro/main_categories3.php?cat=1&order=recent&page=".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://videonews.ro/main_categories3.php?cat=1&order=recent&page=1");
    }
}
