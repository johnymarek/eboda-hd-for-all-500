...
<channel>
	<title>videonews.ro - alte sporturi</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://videonews.ro/main_categories3.php?cat=2&order=recent&page=".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://videonews.ro/main_categories3.php?cat=2&order=recent&page=1");
    }
}
...
$videos = explode('<div class="clsVideoThumbDetails">', $html);
