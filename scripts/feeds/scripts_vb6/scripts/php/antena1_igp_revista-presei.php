...
<channel>
	<title>In gura presei - Revista presei</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://ingurapresei.antena1.ro/ajax.php?action=showVideosArchive&section=revista-presei&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
