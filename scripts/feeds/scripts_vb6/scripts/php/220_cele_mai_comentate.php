...
<channel>
	<title>220.ro - Cele Mai Comentate</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.220.ro/cele-mai-comentate/".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.220.ro/cele-mai-comentate/");
    }
}
