...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/tech/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/tech/1");
    }
}
