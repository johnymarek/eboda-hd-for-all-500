...
<channel>
	<title>UEFA - Football first</title>
	<menu>main menu</menu>
...
if($page) {
    $html = file_get_contents("http://www.uefa.com/uefa/footballfirst/index,page=".$page.".htmx");
} else {
    $page = 1;
    $html = file_get_contents("http://www.uefa.com/uefa/footballfirst/index.html");
}
...
$pos = strpos($html, '<li class="vThumbItem fl">');
if ($pos === false) {
