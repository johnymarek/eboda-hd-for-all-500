...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/gb/official/channel/sport/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/gb/official/channel/sport/1");
    }
}
