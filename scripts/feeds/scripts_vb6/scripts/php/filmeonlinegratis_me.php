...
<channel>
	<title>www.filmeonlinegratis.me</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.filmeonlinegratis.me/page/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.filmeonlinegratis.me/");
    }
}
