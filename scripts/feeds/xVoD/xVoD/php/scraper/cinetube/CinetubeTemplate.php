...
class CinetubeTemplate {
    ...
    const VIEW_DOCUMENTARY = 5;
    const VIEW_DOCUMENTARY_EPISODE = 6;
    ...
    public function generateView($category, $title = null) {
        ...
        switch($category) {
            case CinetubeTemplate::VIEW_HOME;
                $this->getHomeHeader();
                break;
            case CinetubeTemplate::VIEW_CATEGORY;
                $this->getCategoryHeader();
                break;
            case CinetubeTemplate::VIEW_PAGE_NUMBERS:
                $this->getPageNumbersHeader();
                break;

            case CinetubeTemplate::VIEW_MOVIE;
                $this->getMovieHeader();
                break;
            case CinetubeTemplate::VIEW_MOVIE_DETAIL;
                $this->getMovieDetailHeader();
                break;

            case CinetubeTemplate::VIEW_DOCUMENTARY;
                $this->getDocumentaryHeader();
                break;
            case CinetubeTemplate::VIEW_DOCUMENTARY_EPISODE;
                $this->getDocumentaryEpisodeHeader();
                break;

            case CinetubeTemplate::VIEW_SERIE;
                $this->getSerieHeader();
                break;
            case CinetubeTemplate::VIEW_SERIE_SEASON;
                $this->getSerieSeasonHeader();
                break;
            case CinetubeTemplate::VIEW_SERIE_EPISODE;
                $this->getSerieSeasonEpisodeHeader();
                break;
            case CinetubeTemplate::VIEW_SERIE_EPISODE_LINK;
                $this->getSerieSeasonEpisodeLinkHeader();
                break;


            case CinetubeTemplate::VIEW_PLAY;
                $this->getPlayHeader();
                break;
        }
        ...
        if ($category == CinetubeTemplate::VIEW_SERIE_SEASON) {
        ...
        }else if($category == CinetubeTemplate::VIEW_SERIE_EPISODE ) {
            $i = 1;
...
<mediaDisplay name="photoView"
    ...
    <itemDisplay>
        ...
        <text redraw="yes"
            ...
            <foregroundColor>
                <script>
                    if( getItemInfo(-1,"itemid") &lt; <?php echo (($this->type == "mov") ? "9" : "3"); ?> )
                    "0:154:205";
                    else
                        "255:255:255";
                </script>
...
<mediaDisplay name="photoView"
    ...
    <text redraw="yes"
          backgroundColor="0:0:0" foregroundColor="255:255:255"
          offsetXPC="30" offsetYPC="93" widthPC="60" heightPC="5" fontSize="12" lines="1">
        <script>
            getItemInfo("description");
        </script>
    </text>
    ...
    <text redraw="yes"
          backgroundColor="0:0:0" foregroundColor="255:255:255"
          offsetXPC="30" offsetYPC="89" widthPC="60" heightPC="5" fontSize="16" lines="1">
        <script>
            getItemInfo("title");
        </script>
    </text>
    ...
    <text redraw="no"
          ...
          offsetXPC="30" offsetYPC="85.5" widthPC="60" heightPC="4" fontSize="12" lines="1">
        <script>
            "<?php echo strtoupper(utf8_encode($this->title)); ?>";
        </script>
    </text>
    ...
    <text redraw="no"
        ...
        <![CDATA[<?php echo resourceString("header_menu_add_bookmark"); ?>]]>
            ...
            <?php
            if($this->searchTerm) {
                $nextPageLink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage>1) ? ($this->actualPage-1) : 1) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "PHPSESID=" . session_id();
                $lastPageLink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage<$this->maxPages) ? ($this->actualPage+1) : $this->maxPages) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "PHPSESID=" . session_id();
                $gotoPagelink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "pages=". $this->maxPages . URL_AMP . "page=x" . URL_AMP . "PHPSESID=" . session_id();
            }else {
                $nextPageLink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage>1) ? ($this->actualPage-1) : 1) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "PHPSESID=" . session_id();
                $lastPageLink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage<$this->maxPages) ? ($this->actualPage+1) : $this->maxPages) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "PHPSESID=" . session_id();
                $gotoPagelink = SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "page=x" . URL_AMP . "PHPSESID=" . session_id();
            }
            ?>
...
<homePageLink>
    <link>
            <?php echo SCRAPER_URL."index.php?type=" . $this->type . URL_AMP . "PHPSESID=" . session_id(); ?>
    </link>
</homePageLink>
...
<mediaDisplay name="threePartsView"
    ...
    <text redraw="no"
          ...
          offsetXPC="23" offsetYPC="43.5" widthPC="48" heightPC="36" fontSize="11" lines="13">
        <script>
            getItemInfo("description");
        </script>
    </text>
...
<homePageLink>
     ...
     * -------------------------------------------------------------------------
     */
    private function getDocumentaryHeader() {
        $this->getMovieHeader();
    }
     ...
     * -------------------------------------------------------------------------
     */
    private function getDocumentaryEpisodeHeader() {
        ?>
<mediaDisplay name="threePartsView"
              showDefaultInfo="no" bottomYPC="0" itemGap="0" itemPerPage="8"
              ...
              idleImageXPC="90" idleImageYPC="5" idleImageWidthPC="5" idleImageHeightPC="8"
              imageFocus="null" imageUnFocus="null" imageParentFocus="null"
              backgroundColor="0:0:0" drawItemText="yes" imageBorderPC="0">
                          <?php xVoDLoader(); ?>
    ...
    <!-- PAGE DOCUMENTARY TITLE -->
    <text redraw="no"
          backgroundColor="-1:-1:-1" foregroundColor="0:154:205"
          offsetXPC="23" offsetYPC="23.5" widthPC="35" heightPC="5" fontSize="16" lines="1">
                      <?php echo "<![CDATA[" . utf8_encode(strtoupper($this->movieTitle)) . "]]>"; ?>
    </text>

    <!-- EPISODE TITLE -->
    <text redraw="yes"
          backgroundColor="0:0:0" foregroundColor="255:255:255"
          offsetXPC="23" offsetYPC="28.5" widthPC="35" heightPC="6" fontSize="14" lines="2">
        <script>
            getItemInfo("title");
        </script>
    </text>
    ...
    <text redraw="no"
          backgroundColor="-1:-1:-1" foregroundColor="160:160:160"
          offsetXPC="23" offsetYPC="36" widthPC="46" heightPC="32" fontSize="11" lines="12">
        <script>
            getItemInfo("description");
        </script>
    </text>
...
<homePageLink>
    <link>
            <?php echo SCRAPER_URL."index.php?type=doc" . URL_AMP . "PHPSESID=" . session_id(); ?>
    </link>
</homePageLink>
...
<mediaDisplay name="threePartsView"
    ...
    <text redraw="no"
        ...
        <![CDATA[<?php echo utf8_encode(strtoupper($this->movieTitle)); ?>]]>
    </text>
...
<homePageLink>
    <link>
            <?php echo SCRAPER_URL."index.php?type=ser" . URL_AMP . "PHPSESID=" . session_id(); ?>
    </link>
</homePageLink>
        <?php
    }
...
<mediaDisplay name="photoView"
    ...
    <text redraw="yes"
          backgroundColor="-1:-1:-1" foregroundColor="0:154:205"
          offsetXPC="28" offsetYPC="50" widthPC="50" heightPC="10" fontSize="18" lines="1">
        <![CDATA[<?php echo strtoupper($this->movieTitle); ?>]]>
    </text>
    ...
    <text redraw="yes" itemAlignt="right"
          ...
          offsetXPC="40" offsetYPC="45" widthPC="60" heightPC="5" fontSize="12" lines="1">
        <script>
            "<?php echo utf8_encode(strtoupper( $this->seasonTitle ) . ". " . resourceString("screen_string_episode")); ?> " + getItemInfo("title") + ": " + getItemInfo("description");
        </script>
    </text>
...
<mediaDisplay name="threePartsView"
    ...
    <text redraw="no"
          backgroundColor="-1:-1:-1" foregroundColor="0:154:205"
          offsetXPC="23" offsetYPC="27" widthPC="35" heightPC="3" fontSize="12" lines="1">
    ...
    <text redraw="no"
          backgroundColor="-1:-1:-1" foregroundColor="0:154:205"
          offsetXPC="23" offsetYPC="30" widthPC="35" heightPC="3" fontSize="12" lines="1">
    ...
    <text redraw="yes"
          backgroundColor="0:0:0" foregroundColor="255:255:255"
          offsetXPC="23" offsetYPC="34" widthPC="35" heightPC="6" fontSize="12" lines="2">
        <script>
            getItemInfo("title");
        </script>
    </text>
...
<mediaDisplay name="threePartsView"
    ...
    <text redraw="no"
          backgroundColor="-1:-1:-1" foregroundColor="0:154:205"
          offsetXPC="23" offsetYPC="23.5" widthPC="50" heightPC="7" fontSize="16" lines="2">
                      <![CDATA[<?php echo strtoupper($this->movieTitle); ?>]]>
    </text>
...
<homePageLink>
    ...
    private function showEpisodeItem($episodeNumber,$episodeName,$episodeLink) {
        $link = SCRAPER_URL . "index.php?type=" . $this->type . URL_AMP . "episodeName=" . base64_encode($episodeName) . URL_AMP . "episode=" . base64_encode($episodeLink) . URL_AMP . "seasonNum=" . $this->selectedSeason . URL_AMP . "PHPSESID=" . session_id();
        echo "          <item>\n";
