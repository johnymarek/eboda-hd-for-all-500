...
class Anime44MoviesTemplate {
    ...
    public function generateView($category, $title = null) {
        ...
        switch($category) {
            case Anime44MoviesTemplate::VIEW_CATEGORY;
                $this->getCategoryHeader();
                break;
            case Anime44MoviesTemplate::VIEW_PAGE_NUMBERS:
                $this->getPageNumbersHeader();
                break;

            case Anime44MoviesTemplate::VIEW_MOVIE;
                $this->getMovieHeader();
                break;
            case Anime44MoviesTemplate::VIEW_MOVIE_DETAIL;
                $this->getMovieDetailHeader();
                break;

            case Anime44MoviesTemplate::VIEW_PLAY;
                $this->getPlayHeader();
                break;
        }
...
<mediaDisplay name="threePartsView"
    ...
    <!-- COVER IMAGE -->
    <image redraw="no" offsetXPC="2.8" offsetYPC="35.8" widthPC="18.9" heightPC="24" backgroundColor="-1:-1:-1" >
                <?php echo $this->image; ?>
    </image>
