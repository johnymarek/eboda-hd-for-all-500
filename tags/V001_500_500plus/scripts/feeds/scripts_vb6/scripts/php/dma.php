...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/auto/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/auto/1");
    }
}
