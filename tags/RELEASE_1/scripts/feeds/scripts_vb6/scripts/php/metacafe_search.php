...
//http://www.metacafe.com/tags/Movie_Trailers/page-2/
if($page) {
    if($search) {
        $html = file_get_contents("http://www.metacafe.com/tags/".$search."/page-".$page."/");
    } else {
    ...
    $page = 1;
    if($search) {
        $html = file_get_contents("http://www.metacafe.com/tags/".$search."/");
    } else {
...
<link><?php echo $url;?></link><media:thumbnail url="/tmp/volumes/HDD1/scripts/image/left.jpg" />
</item>
...
<media:thumbnail url="/tmp/volumes/HDD1/scripts/image/right.jpg" />
</item>
