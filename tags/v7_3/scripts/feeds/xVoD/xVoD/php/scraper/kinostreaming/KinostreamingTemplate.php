...
class KinostreamingTemplate {
    ...
    public function generateView($category, $title = null) {
        ...
        switch($category) {
            case KinostreamingTemplate::VIEW_CATEGORY;
                $this->getCategoryHeader();
                break;
            case KinostreamingTemplate::VIEW_PAGE_NUMBERS:
                $this->getPageNumbersHeader();
                break;

            case KinostreamingTemplate::VIEW_MOVIE;
                $this->getMovieHeader();
                break;
            case KinostreamingTemplate::VIEW_MOVIE_DETAIL;
                $this->getMovieDetailHeader();
                break;

            case KinostreamingTemplate::VIEW_PLAY;
                $this->getPlayHeader();
                break;
        }
