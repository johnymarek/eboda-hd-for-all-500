...
>
  ...
  <audioDispatcher>
    ...
    streamArray = pushBackStringArray(streamArray, "1");
    writeStringToFile(storagePath_stream, streamArray);
    doModalRss("<?php echo $host; ?>/scripts/tv/audioRenderer.rss");
  </audioDispatcher>
...
<channel>
  ...
  <item>
    <title>România Actualitaţi</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>mms://stream1.srr.ro/romania_actualitati_128</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>mms</stream_protocol>
  </item>
  <item>
    <title>România Muzical</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>mms://stream1.srr.ro/romania_muzical_128</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>mms</stream_protocol>
  </item>
  <item>
    <title>România Cultural</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>mms://stream1.srr.ro/romania_cultural_128</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>mms</stream_protocol>
  </item>
  <item>
    <title>Radio 3 Net "Florian Pittiş"</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>http://media.3netmedia.ro:8000/Radio3Net</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>http</stream_protocol>
  </item>
  <item>
    <title>Antena Satelor</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>http://89.238.227.6:8040/</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>http</stream_protocol>
  </item>
  <item>
    <title>România Internaţional</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>mms://stream1.srr.ro/romania_international1_128</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>mms</stream_protocol>
  </item>
  <item>
    <title>e.teatru.ro</title>
    <location>http://www.radioromania.ro/</location>
    <stream_url>http://media.3netmedia.ro:8000/teatru</stream_url>
    <stream_class>audio</stream_class>
    <stream_protocol>http</stream_protocol>
  </item>
</channel>
