...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.pornhub.com/video?o=mr&page=".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.pornhub.com/");
    }
}
...
<?php
$videos = explode('li class="videoblock  videos_', $html);
unset($videos[0]);
