...
<channel>
	<title>www.efilmeonline.ro</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.efilmeonline.ro/index.php?pag=".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.efilmeonline.ro/");
    }
}
...
$html = str_between($html,'<div class="listare_filme">','<div class="page_nav clearfix">');
...
foreach($videos as $video) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://www.efilmeonline.ro".$t2[0];
