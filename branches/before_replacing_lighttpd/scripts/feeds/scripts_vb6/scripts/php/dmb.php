...
<channel>
	<title>dailymotion - Bollywood</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/playlist/x13t6c_dailymotion_india_pbollywoodexclusive/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/playlist/x13t6c_dailymotion_india_pbollywoodexclusive/1");
    }
}
