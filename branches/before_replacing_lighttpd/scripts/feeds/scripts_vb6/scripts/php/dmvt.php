...
<channel>
	<title>dailymotion - visited today</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/visited-today/".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/visited-today/1");
    }
}
