...
foreach($videos as $video) {
   ...
   if (strcmp($link,$lastlink)) {
    ...
    $lastlink = $link;
	 ...
	 $title = "megavideo (V2)- file=".$id;
   $link = "http://estosesale.com/megavideotito.php?video_id=".$id;
   if (strcmp($link,$lastlink)) {
    echo '<item>';
    echo '<title>'.$title.'</title>';
    echo '<link>'.$link.'</link>';
    ...
    $lastlink = $link;
	 ...
	 $title = "megavideo (V3)- file=".$id;
   $link = "http://estosesale.com/megavideotito2.php?megavideo_link=http://www.megavideo.com/?v=".$id;
   if (strcmp($link,$lastlink)) {
    echo '<item>';
    echo '<title>'.$title.'</title>';
    echo '<link>'.$link.'</link>';
