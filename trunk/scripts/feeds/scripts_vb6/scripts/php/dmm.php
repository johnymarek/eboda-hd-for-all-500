...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/gb/featured/channel/music/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/gb/featured/channel/music/1");
    }
}
