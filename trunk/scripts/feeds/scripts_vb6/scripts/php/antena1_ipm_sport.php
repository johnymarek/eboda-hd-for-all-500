...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://inpuiimei.antena1.ro/ajax.php?action=showVideosArchive&section=sport&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
