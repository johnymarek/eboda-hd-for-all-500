...
<channel>
	<title>Un show pacatos - Momente pacatoase</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://unshowpacatos.antena1.ro/ajax.php?action=showVideosArchive&section=momente-pacatoase&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
