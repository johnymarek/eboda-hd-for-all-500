...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.jurnaltv.ro/videos/recent/page".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.jurnaltv.ro/videos");
    }
}
...
$videos = explode('<table cellpadding=0 cellspacing=0 border=0 width="100%" class="p', $html);
