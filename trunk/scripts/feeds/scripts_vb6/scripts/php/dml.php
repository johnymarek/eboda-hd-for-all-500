...
<channel>
	<title>dailymotion - lifestyle</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/lifestyle/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/featured/channel/lifestyle/1");
    }
}
