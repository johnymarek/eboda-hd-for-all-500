...
if($page) {
    $html = file_get_contents("http://www.uefa.com/worldcup/video/index,page=".$page.".htmx");
} else {
    $page = 1;
    $html = file_get_contents("http://www.uefa.com/worldcup/video/index.html");
}
...
foreach($videos as $video) {
    ...
    $t2 = explode('.', $t1[1]);
    	...
    	$t1 = explode('<div class="vdate w6">', $video);
    	$t2 = explode('<', $t1[1]);
    	$data = trim($t2[0]);
