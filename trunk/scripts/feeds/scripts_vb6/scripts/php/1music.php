...
if($page) {
    ...
    if($search) {
        ...
        $html = file_get_contents("http://www.1music.ro/videoclipuri/?pagina=".$page1);
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.1music.ro/videoclipuri/?pagina=0");
    }
}
