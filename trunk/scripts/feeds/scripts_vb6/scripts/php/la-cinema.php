...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://la-cinema.net/page/".$page."/");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://la-cinema.net/");
    }
}
...
$videos = explode('<div class="datebig">', $html);
