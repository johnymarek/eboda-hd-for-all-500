...
<channel>
	<title>dailymotion - Sports and Extreme</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/channel/sport/".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.dailymotion.com/en/channel/sport/1");
    }
}
...
$videos = explode('<div class="dmpi_video_preview image_border">', $html);
