...
<channel>
	<title>Neatza - Reteta lui Vladutz</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
		...
		$html = file_get_contents("http://neatza.antena1.ro/ajax.php?action=showVideosArchive&section=reteta-lui-vladutz&limit=10&page=".$page."&offset=0");
    }
} else {
    $page = 1;
    if($search) {
