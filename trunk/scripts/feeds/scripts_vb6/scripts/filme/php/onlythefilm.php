...
//http://www.onlythefilm.com/page/2/
if($page) {
	$html = file_get_contents("http://www.onlythefilm.com/page/".$page."/");
} else {
    $page = 1;
...
//  imagine  
  ...
  $image = $v2[0];  
//  descriere  
  $descriere = str_between($video,'<p style="text-align: center;">','</p>');
