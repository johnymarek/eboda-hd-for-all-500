...
$html = file_get_contents("http://serialepenet.ro/");
$videos = explode('<div class="views-field-title">', $html);
...
foreach($videos as $video) {
   ...
   $t4=explode("<",$t3[1]);
   $title=$t4[0];
   $link = $host."/scripts/filme/php/serialepenet.php?file=".$link.",".urlencode($title);
    echo '
    <item>
    <title>'.$title.'</title>
