...
if ($pos !== false) {
  ...
  } elseif (strpos($image,"86.55.8.134") !==false) {
    //http://86.55.8.134:8080/Oamenii%20timpului%20nostru/Oamenii%20timpului%20nostru-01-30-2011-1.jpg
    $link = substr($image, 0, -6).".flv";
  } else {
    //http://antena2.ro/img/thumb_a2.jpg
    //http://86.55.8.134:8080/Confidential/Confidential-01-30-2011.flv
    $html = file_get_contents($link);
    $t0=explode('<div id="video-holder">',$html);
