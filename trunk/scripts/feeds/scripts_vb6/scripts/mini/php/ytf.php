...
<channel>
	<title>YouTube - Top Favorited</title>
	<menu>main menu</menu>
...
if($page) {
    if($search) {
        ...
        $html = file_get_contents("http://www.youtube.com/videos?s=mf&t=t&cr=US&p=".$page."");
    }
} else {
    $page = 1;
    if($search) {
        ...
        $html = file_get_contents("http://www.youtube.com/videos?s=mf&t=t&cr=US&p=1");
    }
}
