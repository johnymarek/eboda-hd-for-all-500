...
class CinetubeAnimeTemplate {
    ...
    public function generateView($category, $title = null) {
        ...
        switch($category) {
            case CinetubeAnimeTemplate::VIEW_HOME;
                $this->getHomeHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_CATEGORY;
                $this->getCategoryHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_PAGE_NUMBERS:
                $this->getPageNumbersHeader();
                break;

            case CinetubeAnimeTemplate::VIEW_MOVIE;
                $this->getMovieHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_MOVIE_DETAIL;
                $this->getMovieDetailHeader();
                break;

            case CinetubeAnimeTemplate::VIEW_SERIE;
                $this->getSerieHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_SERIE_SEASON;
                $this->getSerieSeasonHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_SERIE_EPISODE;
                $this->getSerieSeasonEpisodeHeader();
                break;
            case CinetubeAnimeTemplate::VIEW_SERIE_EPISODE_LINK;
                $this->getSerieSeasonEpisodeLinkHeader();
                break;


            case CinetubeAnimeTemplate::VIEW_PLAY;
                $this->getPlayHeader();
                break;
        }
        ...
        if ($category == CinetubeAnimeTemplate::VIEW_SERIE_SEASON) {
        ...
        }else if($category == CinetubeAnimeTemplate::VIEW_SERIE_EPISODE ) {
            $i = 1;
...
<homePageLink>
    <link>
            <?php echo SERVER_HOST_AND_PATH."php/anime.php"; ?>
    </link>
</homePageLink>
        <?php
    }
...
<mediaDisplay name="photoView"
    ...
    <text redraw="no"
        ...
        <script>
            "<?php echo utf8_decode(strtoupper($this->title)); ?>";
        </script>
    </text>
    ...
    <text redraw="no"
        ...
        <![CDATA[<?php echo resourceString("header_menu_add_bookmark"); ?>]]>
            ...
            <?php
            if($this->searchTerm) {
                $nextPageLink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage>1) ? ($this->actualPage-1) : 1) . URL_AMP . "pages=" . $this->maxPages;
                $lastPageLink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage<$this->maxPages) ? ($this->actualPage+1) : $this->maxPages) . URL_AMP . "pages=" . $this->maxPages;
                $gotoPagelink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "search=" . $this->searchTerm . URL_AMP . "pages=". $this->maxPages . URL_AMP . "page=x";
            }else {
                $nextPageLink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage>1) ? ($this->actualPage-1) : 1) . URL_AMP . "pages=" . $this->maxPages;
                $lastPageLink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "title=" . base64_encode($this->title) . URL_AMP . "page=" . (($this->actualPage<$this->maxPages) ? ($this->actualPage+1) : $this->maxPages) . URL_AMP . "pages=" . $this->maxPages;
                $gotoPagelink = SCRAPER_URL."anime.php?type=" . $this->type . URL_AMP . "cat=" . base64_encode($this->category) . URL_AMP . "pages=" . $this->maxPages . URL_AMP . "page=x";
            }
            ?>
...
<homePageLink>
    <link>
            <?php echo SCRAPER_URL."anime.php?type=" . $this->type; ?>
    </link>
</homePageLink>
...
<homePageLink>
    <link>
            <?php echo SCRAPER_URL."anime.php?type=ser"; ?>
    </link>
</homePageLink>
        <?php
    }
...
<homePageLink>
    ...
    private function showSeasonItem($season, $seasonArray) {
        ...
        $data = $season;
        $link = SCRAPER_URL . "anime.php?type=" . $this->type . URL_AMP . "season=" . base64_encode($data) . URL_AMP . "PHPSESID=" . session_id();
        echo "          <item>\n";
    ...
    private function showEpisodeItem($episodeNumber,$episodeName,$episodeLink) {
        $link = SCRAPER_URL . "anime.php?type=" . $this->type . URL_AMP . "episodeName=" . base64_encode($episodeName) . URL_AMP . "episode=" . base64_encode($episodeLink) . URL_AMP . "seasonNum=" . $this->selectedSeason . URL_AMP . "PHPSESID=" . session_id();
        echo "          <item>\n";
