...
class MegastreamingTemplate {
    ...
    public function generateView($category, $title = null) {
        ...
        switch($category) {
            case MegastreamingTemplate::VIEW_HOME;
                $this->getHomeHeader();
                break;
            case MegastreamingTemplate::VIEW_CATEGORY;
                $this->getCategoryHeader();
                break;
            case MegastreamingTemplate::VIEW_PAGE_NUMBERS:
                $this->getPageNumbersHeader();
                break;

            case MegastreamingTemplate::VIEW_MOVIE;
                $this->getMovieHeader();
                break;
            case MegastreamingTemplate::VIEW_MOVIE_DETAIL;
                $this->getMovieDetailHeader();
                break;

            case MegastreamingTemplate::VIEW_SERIE;
                $this->getSerieHeader();
                break;
            case MegastreamingTemplate::VIEW_SERIE_SEASON;
                $this->getSerieSeasonHeader();
                break;
            case MegastreamingTemplate::VIEW_SERIE_EPISODE;
                $this->getSerieSeasonEpisodeHeader();
                break;
            case MegastreamingTemplate::VIEW_SERIE_EPISODE_LINK;
                $this->getSerieSeasonEpisodeLinkHeader();
                break;


            case MegastreamingTemplate::VIEW_PLAY;
                $this->getPlayHeader();
                break;
        }
        ...
        if ($category == MegastreamingTemplate::VIEW_SERIE_SEASON) {
        ...
        }else if($category == MegastreamingTemplate::VIEW_SERIE_EPISODE ) {
            $i = 1;
...
<mediaDisplay name="threePartsView"
    ...
    <backgroundDisplay>
        <image offsetXPC="0" offsetYPC="0" widthPC="100" heightPC="100">
                    <?php echo XTREAMER_IMAGE_PATH; ?>background/movie-detail_2.png
        </image>
    </backgroundDisplay>
...
<mediaDisplay name="photoView"
    ...
    <backgroundDisplay>
        <image offsetXPC="0" offsetYPC="0" widthPC="100" heightPC="100">
                    <? echo XTREAMER_IMAGE_PATH; ?>background/movie-detail_2.png
        </image>
    </backgroundDisplay>
</mediaDisplay>
